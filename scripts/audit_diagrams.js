...
const OK={
 'Rýchlym vedením lopty':['slalom','gates','channel','through','ssg','duel','grid','tag','press','zones'],
 '1v1 KÚ/KO':['duel','channel','cross','ssg','duelWave','gk1v1','shoot'],
 '1v1 SÚ/SSH/KÚ (chrbtom k bránke)':['pivot','through','grid','ssg','duel'],
 '1v1 SO/SSH/SÚ (v čelnom postavení)':['duel','grid','ssg','channel'],
 'Prvým dotykom (ofenzívny / otvorený)':['pass3','positional','zones','ssg','grid','through','rondo','pivot'],
 'Prienikovou prihrávkou':['through','pass3','wall','positional','zones','targetZone'],
 ...
 'Krytie lopty (jednotlivca)':['grid','ssg','tag','press','duel','channel'],
 'Držanie lopty (skupinou hráčov)':['rondo','positional','ssg','grid','zones'],
 'Zakončenie po vedení lopty / kľučke':['shoot','duel','gk1v1','through','duelWave'],
